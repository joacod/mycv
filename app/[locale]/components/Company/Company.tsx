          ...
          <div className="mb-8 rounded-lg bg-black p-6 text-gray-300 shadow-lg">
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <BiSolidZap className="mr-2 h-6 w-6 shrink-0" />
                <span>{t("card1")}</span>
              </li>
              <li className="flex items-start">
                <IoMdClock className="mr-2 h-6 w-6 shrink-0" />
                <span>{t("card2")}</span>
              </li>
              <li className="flex items-start">
                <IoRocket className="mr-2 h-6 w-6 shrink-0" />
                <span>{t("card3")}</span>
              </li>
              <li className="flex items-start">
                <FaBrain className="mr-2 h-6 w-6 shrink-0" />
                <span>{t("card4")}</span>
              </li>
            </ul>
          </div>
